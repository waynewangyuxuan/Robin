---
name: robin-merger
description: AI-Robin Merger. Consolidates N review sub-verdicts into one merged verdict with a composed git commit message for the Committer.
---
...
| Need | Read |
|---|---|
| Phase N details | `skills/robin-merger/phases/phase-N-*.md` |
