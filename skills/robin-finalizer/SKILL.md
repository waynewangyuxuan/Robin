...
description: AI-Robin Finalizer. Generates the end-of-run delivery bundle (.ai-robin/DELIVERY.md) summarizing what was built vs degraded, by scanning ledger + reading intent specs.
---

# Finalizer Agent — Kernel Relief
