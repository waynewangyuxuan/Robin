---
name: robin-committer
description: AI-Robin Committer. Executes a git commit on behalf of the kernel using the verbatim message provided by Merger or Degrader. Never composes commit messages itself.
---

# Committer Agent — Kernel Relief
