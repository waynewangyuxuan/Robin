# Scheduler Phase 1: Load state and identify executable milestones
...
Read:
- `META/00-robin-plan/progress.yaml` — global milestone registry
- Each affected Room's `progress.yaml` — Room-level milestone status
- `META/00-robin-plan/specs/` — all plan specs (decisions, contracts)
