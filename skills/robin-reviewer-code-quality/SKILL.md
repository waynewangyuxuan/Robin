...
description: AI-Robin code-quality reviewer. Always-on review that evaluates correctness, readability, maintainability, error handling, testing, and basic security across changed code. Produces a structured sub-verdict.
---
