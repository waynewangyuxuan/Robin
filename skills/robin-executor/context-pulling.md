...
Main agent (via Scheduler) provides `context_refs` — a list of
spec_ids. These are the specs Scheduler determined are needed
...
bloats. If a relation is important, Scheduler should have
...
- **Other Rooms' internal specs** — only load specs in your
  `context_refs`. If another Room's spec was relevant, Scheduler
...
Scheduler should have caught this, but occasionally misses
...
off — either Scheduler gave too broad a scope, or the milestone
is too big.
