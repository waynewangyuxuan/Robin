...
description: AI-Robin Researcher. Answers a specific factual question Planner needs to finalize a plan. Uses web search + targeted analysis to produce structured findings with confidence.
---
