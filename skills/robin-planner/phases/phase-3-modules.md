...
META/
├── 00-project-room/
├── 00-robin-plan/          # Your planning output
├── 01-{module-a}/
├── 02-{module-b}/
├── 03-{module-c}/
└── ...
...
If Intake already created epic-level Rooms, further decompose those
into feature-level Rooms. If Intake created feature-level, you may
just populate them.
...
in `META/00-robin-plan/specs/`). Module list feeds Phase 4 (contracts)
