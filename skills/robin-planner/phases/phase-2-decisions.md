...
- **Framework/stack** — if not already decided by Intake. Often Intake
...
1. **Check if Intake already decided it.** If yes, reference the spec.
   Don't duplicate.
...
A set of decision specs written to `META/00-robin-plan/specs/`. These
