...
所有 spec 都落盘到 Feature Room 格式的目录。这个格式是从原 Feature Room skill 复用的，不是 AI-Robin 自造的。详见 `stdlib/feature-room-spec.md` 和 `references/feature-room-mapping.md`。
