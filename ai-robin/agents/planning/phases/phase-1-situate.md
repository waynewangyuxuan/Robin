...
1. Read all spec_ids listed in `consumer_output.specs_summary`. Build a
   ...
   - What did Consumer proxy-decide (and why)?
2. Ensure `META/00-ai-robin-plan/` exists. If not, create it with:
...
**Do NOT restart from scratch.** Load `agents/planning/replan-protocol.md`.
...
3. Work within a sub-room (e.g., `META/00-ai-robin-plan-{scope}/`)
...
- What constraints bind you (from Consumer, from parent plan, from
