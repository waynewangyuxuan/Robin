...
- To: `pending` (ready to be re-dispatched by Execute-Control)

This lets Execute-Control re-dispatch them in the next batch.
...
Execute-Control will pick up and re-dispatch.
