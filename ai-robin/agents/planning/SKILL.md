...
4. `agents/planning/contract-design.md` — inter-module API contract methodology
5. `agents/planning/parallelism-identification.md` — how to identify concurrent-safe boundaries
6. `agents/planning/replan-protocol.md` — how to respond to replan invocations
...
- `planning_complete` — plan ready, advance to Execute-Control
...
Primary artifacts written to `META/00-ai-robin-plan/` (or sub-plan room
for `sub_planning`):
...
- **Do not ask the user anything.** No user interaction after Consumer.
...
| Need | Read |
|---|---|
| Phase N details | `agents/planning/phases/phase-N-*.md` |
| Contract design methodology | `agents/planning/contract-design.md` |
| Parallelism identification | `agents/planning/parallelism-identification.md` |
| Replan protocol | `agents/planning/replan-protocol.md` |
