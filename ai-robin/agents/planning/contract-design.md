...
Consumer code cannot handle errors it doesn't know about. Skipping error
...
- **Consumer side**: does the caller have enough information to use this
...
- **Implementation-first contracts** ("uses Postgres with..."). Conflates
  what and how.
- **No error spec**. Consumer code can't handle what's not documented.
