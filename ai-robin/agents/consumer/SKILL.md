...
3. `agents/consumer/decision-taxonomy.md` — project-type-specific decision points to cover
4. `agents/consumer/question-prioritization.md` — question ranking methodology
5. `agents/consumer/completeness-check.md` — the pre-return checklist
...
| Need | Read |
|---|---|
| Phase N details | `agents/consumer/phases/phase-N-*.md` |
| Decision points per project type | `agents/consumer/decision-taxonomy.md` |
| Question ranking methodology | `agents/consumer/question-prioritization.md` |
| Completeness checklist | `agents/consumer/completeness-check.md` |
