...
within a batch (per Execute-Control's dispatch).
...
3. `agents/execute/context-pulling.md` — rules for loading only relevant context
4. `agents/execute/commit-preparation.md` — how to prepare the change artifact
...
| Need | Read |
|---|---|
| Phase N details | `agents/execute/phases/phase-N-*.md` |
| Context pulling rules | `agents/execute/context-pulling.md` |
| Change spec format | `agents/execute/commit-preparation.md` |
