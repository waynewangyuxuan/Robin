...
2. `agents/execute-control/concurrency-rules.md` — rules for parallel vs serial
...
| Need | Read |
|---|---|
| Phase N details | `agents/execute-control/phases/phase-N-*.md` |
| Concurrency rules | `agents/execute-control/concurrency-rules.md` |
