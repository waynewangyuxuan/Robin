...
3. `execute/context-pulling.md` — rules for loading only relevant context
4. `execute/commit-preparation.md` — how to prepare the change artifact
...
| Need | Read |
|---|---|
| Phase N details | `execute/phases/phase-N-*.md` |
| Context pulling rules | `execute/context-pulling.md` |
| Change spec format | `execute/commit-preparation.md` |
