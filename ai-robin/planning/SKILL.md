...
4. `planning/contract-design.md` — inter-module API contract methodology
5. `planning/parallelism-identification.md` — how to identify concurrent-safe boundaries
6. `planning/replan-protocol.md` — how to respond to replan invocations
...
| Need | Read |
|---|---|
| Phase N details | `planning/phases/phase-N-*.md` |
| Contract design methodology | `planning/contract-design.md` |
| Parallelism identification | `planning/parallelism-identification.md` |
| Replan protocol | `planning/replan-protocol.md` |
